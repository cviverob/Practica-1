<header>
    ...
    <?php
        if (!isset($_SESSION["login"]) || !$_SESSION["login"]) {
            echo 'Usuario desconocido <a href="' . RUTA_APP . RUTA_LGIN . '" class="LogUserButton">Login</a> <a href="' . RUTA_APP . RUTA_REG . '" class="RegisterUserButton">Registrarse</a>';
        } else {
            ...
            if ($_SESSION["esAdmin"]) {
                if (!isset($_SESSION['modo']) || $_SESSION['modo'] == 'usuario') {
                    ...
                    echo '<a href="' . RUTA_APP . RUTA_INDX . '" class="RegisterUserButton">Inicio</a>';
                }
            } else {
